...
data = dict(
    ...
    test=dict(
        ...
        datasets = [ 
            dict(
                type="MergeDataset",
                split=["val", "validation", "val", "val"],
                data_root=["data/synlidar", "data/waymo", "data/nuscenes", "data/semantic_kitti"],
                data_name=["SynLiDAR", "Waymo", "nuScenes", "SemanticKITTI"],
                pre_transform=[
                    synlidar_pretransform_val,
                    wa_pretransform_val,
                    nu_pretransform_val, 
